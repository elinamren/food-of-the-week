const Time = () => {
  ...
  return (
    <svg className="cook-icon time-icon" width="69" height="56" viewBox="0 0 69 56" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="25.5" cy="30.5" r="24" stroke="black" stroke-width="3"/>
      <path d="M25.5 6V3C25.5 2.44772 25.0523 2 24.5 2H21H30" stroke="black" stroke-width="3"/>
      <path fill-rule="evenodd" clip-rule="evenodd" d="M25.2115 10.4617V30.7885L43.6799 39.6807C40.3348 45.9688 33.7154 50.2501 26.0961 50.2501C15.1035 50.2501 6.19226 41.3388 6.19226 30.3462C6.19226 19.65 14.6294 10.9245 25.2115 10.4617Z" fill="black"/>
